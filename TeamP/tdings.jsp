    ...
    <h1>EX game news</h1>
        <section class="first-section">
            <div class="large-image">
                <a href="" target="_blank">
                    <img src="../image/isg2.jpg" alt="Final Fantasy XVI">
                </a>
            ...
            <div class="small-image">
                <a href="" target="_blank">
                    <img src="../image/isg.jpg" alt="">
                        <img src="../image/isg3.jpg" alt="">
        ...
        <section class="second-section">
          <ul style="te">
	        <li>
	            <a href="">
	                <h3>A year later, Witchfire is playing in the form of a Grimdark RPG studio game</h3>
	                <p>Adrian Cmielarz, co-founder of The Astronauts, talks about the studio's plans.</p>
	            </a>
	        </li>
	        <li>
	            <a href="">
	        ...
	        <li>
	            <a href="">
	                ...
	                <p>90 / 3000발음듣기복사하기필기인식기번역하기
					영어열기/닫기 아이콘
					Medieval Bohemia has no potatoes, but plenty of watermelons. Talk to Warhorse Studios developers about how the upcoming Medieval RPG has expanded over its predecessor.</p>
	            </a>
	        </li>
	        <li>
	            <a href="">
	                <h3>Four months ago, Empire of the Ants reinterpreted the RTS genre in a new, microscopic way</h3>
	                <p>Genre innovation technology that brings realistic ants to life like the picture, and why we can't guarantee that no insects are harmed during game production. Tower</p>
	            </a>
	        </li>
	    </ul>
        </section>
