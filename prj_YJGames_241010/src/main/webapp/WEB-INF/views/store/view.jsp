    ...
    <div class="left-section">
        ...
        <div class="media-gallery-wrapper">
            ...
            <div class="media-gallery" id="media-gallery">
                <img src="./img/snap1.gif" alt="동영상 1 썸네일" data-video-src="./video/intro.mp4">
                <img src="./img/snap1.gif" alt="동영상 2 썸네일" data-video-src="./video/intro.mp4">
                <img src="./img/game1.jpg" alt="이미지 1">
                <img src="./img/game2.jpg" alt="이미지 2">
            </div>
        ...
        <div class="details-section">
            ...
            <div class="details-content" id="details-content">
                <p>이 게임은 흥미진진한 모험과 액션을 중심으로 한 최신 게임입니다.</p>
                <p class="extra-content">
                    출시 이후 여러 업데이트가 추가될 예정이며, 새로운 콘텐츠가 제공될 예정입니다.
                </p>
            </div>
    ...
    <div class="right-section-container">
        <div class="info-section">
            ...
            <div class="system-requirements">
                <h4>시스템 요구 사항</h4>
                <ul>
                    <li>운영체제: Windows 10 (64-bit)</li>
                    <li>프로세서: Intel Core i5-6600K / AMD Ryzen 5 1600</li>
                    <li>메모리: 8GB RAM</li>
                    <li>그래픽: NVIDIA GTX 1060 / AMD Radeon RX 580</li>
                    <li>저장 공간: 50GB의 여유 공간</li>
                </ul>
            </div>
