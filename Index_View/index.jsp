...
<body>
    ...
    <div class="header-content">
       <div class="logo">
	 	  <img src="img/logo.png" alt="사이트 로고" onclick="location.href='Game';" style="cursor: pointer;">
		</div>
    ...
    <ul>
        ...
        <li class="community-menu">
            ...
            <ul class="category-dropdown">
                <li><a class="category-dropdown-a" href="#">Review</a></li>
                <li><a class="category-dropdown-a" href="#">News</a></li>
            </ul>
        </li>
