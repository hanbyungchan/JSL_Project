...
<table border="1" width="500">
		...
		<tr>
			<th>학년</th>
			<td><input type="text" name="t_year" readonly value="${t_year }" size="10"></td>
		</tr>
		<tr>
			<th>반</th>
			<td><input type="text" name="t_class" readonly value="${t_sclass }" size="10"></td>
		</tr>
		<tr>
			<th>번호</th>
			<td><input type="text" name="t_no" readonly value="${t_no }" size="10"></td>
		</tr>
		<tr>
			<th colspan="2">
				<input type="button" onclick="goConfirm()" disabled value="중복확인">
			</th>
		</tr>
		<tr>
			<th>이름</th>
