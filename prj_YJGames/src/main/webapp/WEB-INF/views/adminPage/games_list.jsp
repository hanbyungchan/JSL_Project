        ...
        <tbody>
        	<c:forEach items="${dtos}" var = "dto">
        		...
        		<tr>
                    ...
                    <td>${dto.getG_name()}</td>
                    <td><c:if test="${dto.getG_price() eq '0'}">FREE</c:if>
                    <c:if test="${dto.getG_price() ne '0'}">$${dto.getG_price()}</c:if></td>
                    <td>${dto.getG_developer()}</td>
                    <td>${dto.getS_date()}</td>
                    <td><input type="button" value ="Edit" onclick="goView('${dto.getS_page_no()}')"></td>
