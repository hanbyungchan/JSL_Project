...
<head>
    ...
    <style>
        ...
        .slider {
            position: relative;
            width: 100%;
            height: 500px; /* 높이를 늘려서 이미지와 정보가 잘리지 않도록 설정 */
            margin: 50px auto;
            overflow: hidden;
       ...
       .news-box {
        ...
        .news .img {
            height: 70%; /* 이미지 비율 유지 */
            background-color: #3b3b4f; /* 임시 배경 색 */
        }
   ...
   <div class="news-box">
        ...
        <div class="big-news-row">
            <div class="news-big">
                <a href="#">
                    <span class="img">
                        <img src="img/game1.jpg" alt="큰 뉴스 이미지">
                    </span>
                    <p>큰 뉴스 1</p>
                </a>
            </div>
            <div class="news-big">
                <a href="#">
                    <span class="img">
                        <img src="img/game2.jpg" alt="큰 뉴스 이미지">
                    </span>
                    <p>큰 뉴스 2</p>
                </a>
            </div>
            <div class="news-big">
                <a href="#">
                    <span class="img">
                        <img src="img/game3.jpg" alt="큰 뉴스 이미지">
                    </span>
                    <p>큰 뉴스 3</p>
                </a>
            </div>
        ...
        <div class="small-news-row">
            <div class="news-small">
                <a href="#">
                    <span class="img">
                        <img src="img/game4.jpg" alt="작은 뉴스 이미지">
                    </span>
                    <p>작은 뉴스 1</p>
                </a>
            </div>
            <div class="news-small">
                <a href="#">
                    <span class="img">
                        <img src="img/game5.jpg" alt="작은 뉴스 이미지">
                    </span>
                    <p>작은 뉴스 2</p>
                </a>
            </div>
            <div class="news-small">
                <a href="#">
                    <span class="img">
                        <img src="img/game6.jpg" alt="작은 뉴스 이미지">
                    </span>
                    <p>작은 뉴스 3</p>
                </a>
            </div>
            <div class="news-small">
                <a href="#">
                    <span class="img">
                        <img src="img/game7.jpg" alt="작은 뉴스 이미지">
                    </span>
                    <p>작은 뉴스 4</p>
                </a>
            </div>
